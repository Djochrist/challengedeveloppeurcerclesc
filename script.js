...
const quizContent={
  1:{label:"QUIZ 01 · LUNDI 10 AOÛT",status:"Archive",title:"CHALLENGE DÉVELOPPEUR : LE GPS DU LIVREUR",body:"Le quiz 1 est désormais archive. Il reste accessible pour consultation et téléchargement du PDF.",objective:"Le quiz 1 a déjà eu lieu, mais son énoncé reste disponible dans l'historique permanent.",author:"Van Djengu"},
  2:{label:"QUIZ 02 · MERCREDI 12 AOÛT",status:"En cours",title:"CHALLENGE DÉVELOPPEUR : SYNCHRONISATION OFFLINE",body:"Imagine que tu dois concevoir une application utilisée chaque jour par des agents terrain pour enregistrer des opérations importantes. Les agents travaillent en déplacement avec des connexions Internet irrégulières et doivent terminer leur journée sans perdre de données.",objective:"Objectif : proposer une architecture fiable pour le stockage local, la reprise de synchronisation, la détection des conflits et la cohérence finale des données.",author:"Yves Kalume · Google Developer Expert Android"},
